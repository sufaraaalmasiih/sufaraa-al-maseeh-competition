...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "w-full min-w-0 rounded-lg border border-primary/10 bg-card text-card-foreground shadow-[0_12px_35px_rgba(20,58,90,0.07)]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("space-y-2 p-4 sm:p-5 md:p-6", className)}
    {...props}
  />
));
